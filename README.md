...
<img src="images/03-ws-new-project.png" alt="03-ws-new-project.png" width="400"/>  
...
<img src="images/04-ws-associated-wml.png" alt="04-ws-associated-wml.png" width="400"/>  
...
<img src="images/05-ws-add-wml.png" alt="05-ws-add-wml.png" width="400"/>  
...
<img src="images/06a-wml-new-model.png" alt="06a-wml-new-model.png" width="400"/>  
...
<img src="images/06b-wml-new-model.png" alt="06b-wml-new-model.png" width="400"/>  


Press **[Create]**  

Since your newly created model now opens in WML, we can also deploy it at once.  
<img src="images/07-wml-stored-model.png" alt="07-wml-stored-model.png" width="400"/>  

Select "**Deployments tab**" and click **[Add deployment]**.  
<img src="images/08-wml-new-deployment.png" alt="08-wml-new-deployment.png" width="400"/>  
...
<img src="images/09-wml-deployed-model.png" alt="09-wml-deployed-model.png" width="400"/>  
...
<img src="images/10-ws-assets-models.png" alt="10-ws-assets-models.png" width="400"/>  
...
<img src="images/14-wos-select-wml-2.png" alt="14-wos-select-wml-2.png" width="400"/>  
...
<img src="images/15-wos-select-deployments.png" alt="15-wos-select-deployments.png" width="400"/>  
...
<img src="images/16-wos-select-database.png" alt="16-wos-select-database.png" width="400"/>  
...
<img src="images/17-wos-wml-summary.png" alt="17-wos-wml-summary.png" width="400"/>  

Finally, when the configuration is saved, press **[Configure monitors]**  
<img src="images/18-wos-configuration-saved.png" alt="18-wos-configuration-saved.png" width="400"/>  

**Note**: Leave this page open and complete the next step on another browser tab.  
<img src="images/19-wos-implementation.png" alt="19-wos-implementation.png" width="400"/>  
...
<img src="images/20-ws-open-model.png" alt="20-ws-open-model.png" width="400"/>  
...
<img src="images/21-ws-score-deployment.png" alt="21-ws-score-deployment.png" width="400"/>  
...
<img src="images/22-wos-select-deployment.png" alt="22-wos-select-deployment.png" width="400"/>  


### <a name="step5.2">Step 5.2 - Prepare for monitoring</a>

Select "**Prepare for monitoring**"  
<img src="images/23-wos-configure-monitors.png" alt="23-wos-configure-monitors.png" width="400"/>  
To prepare to monitor, press **[Next]**  

Select type of data as "**Numeric/categorical**"  
<img src="images/24-wos-specify-type-of-input.png" alt="24-wos-specify-type-of-input.png" width="400"/>  
Press **[Next]**  

Select "**Manually configure monitors**"  
<img src="images/25-wos-manually-configure-monitors.png" alt="25-wos-manually-configure-monitors.png" width="400"/>  
Press **[Next]**  

Since this is a "*Risk"/"No-Risk*" type of binary model, select "**Binary classification**"  
<img src="images/26-wos-binary-classification.png" alt="26-wos-binary-classification.png" width="400"/>  
Press **[Next]**  

On the "**Specify location of the training data**" page, the location of sample data should be pre-populated (from the model)  
<img src="images/27-wos-location-of-training-data.png" alt="27-wos-location-of-training-data.png" width="400"/>  
Just press **[Next]**  

The **schema** and **table** info should also be pre-populated (from the model)  
<img src="images/28-wos-select-training-table.png" alt="28-wos-select-training-table.png" width="400"/>  
Just press **[Next]**  

On the "**Select the label column from the training data**", select "**Risk**" as the pre-labeled column.  
<img src="images/29-wos-select-label-column.png" alt="29-wos-select-label-column.png" width="400"/>  
Press **[Next]**  

On the "**Select the features used to train the AI deployment**", select **All** but **NOT** the last one, "\_training".  
<img src="images/30-wos-select-features-used.png" alt="30-wos-select-features-used.png" width="400"/>  
...
<img src="images/31-wos-select-text-and-categories.png" alt="31-wos-select-text-and-categories.png" width="400"/>  
The right options should be selected already by default.  
Press **[Next]**  

Review the monitoring summary.  
<img src="images/32-wos-prepare-monitoring-summary.png" alt="32-wos-prepare-monitoring-summary.png" width="400"/>  
...
Press "**Fairness**"  
<img src="images/33-wos-configure-fairness.png" alt="33-wos-configure-fairness.png" width="400"/>  
Press **[Next]**  

On the "**Select the features to monitor**", select "**Sex**" and "**Age**"  
<img src="images/34-wos-select-features-to-monitor.png" alt="34-wos-select-features-to-monitor.png" width="400"/>  
Press **[Next]**  

On "**Specify reference and monitored groups [Sex]**", drag the values to following groups:  
<img src="images/35-wos-monitored-for-sex.png" alt="35-wos-monitored-for-sex.png" width="400"/>  
Reference group: **male**  
Monitored group: **female**  
Press **[Next]**  

On "**Set fairness alert threshold [Sex]**", drag the slider to **90% fair**  
<img src="images/36-wos-fairness-alert-for-sex.png" alt="36-wos-fairness-alert-for-sex.png" width="400"/>  
Press **[Next]**  

On "**Specify reference and monitored groups [Age]**", set these age values for groups:  
<img src="images/37-wos-monitored-for-age.png" alt="37-wos-monitored-for-age.png" width="400"/>  
...
<img src="images/38-wos-fairness-alert-for-age.png" alt="38-wos-fairness-alert-for-age.png" width="400"/>  
Press **[Next]**  

On "**Specify the favorable outcomes**", drag the values to following groups:  
<img src="images/39-wos-favorable-outcomes.png" alt="39-wos-favorable-outcomes.png" width="400"/>  
Favorable values:	**No Risk**  
Unfavorable values:	**Risk**  
Press **[Next]**  

On "**Set minimum sample size**", drag the slider to value **100**  
<img src="images/40-wos-minimum-sample-size.png" alt="40-wos-minimum-sample-size.png" width="400"/>  
Press **[Next]**  

Review fairness settings summary.  
<img src="images/41-wos-fairness-summary.png" alt="41-wos-fairness-summary.png" width="400"/>  
Press **[Save]** and **[OK]**  

**NOTE**: Did you notice the implementation of a **debiased scoring endpoint**?  
<img src="images/42-wos-debiased-scoring-endpoint.png" alt="42-wos-debiased-scoring-endpoint.png" width="400"/>  
...
Press "**Accuracy**"  
<img src="images/43-wos-configure-accuracy.png" alt="43-wos-configure-accuracy.png" width="400"/>  
Press **[Next]**  

On "**Set accuracy alert threshold**", drag the slider to **90% Good**  
<img src="images/44-wos-accuracy-alert-threshold.png" alt="44-wos-accuracy-alert-threshold.png" width="400"/>  

On "**Set minimum and maximum sample size**", set sliders to following values:  
<img src="images/45-wos-accuracy-sample-rates.png" alt="45-wos-accuracy-sample-rates.png" width="400"/>  
Minimum sample size required before evaluation:	**10**  
Maximum sample size to evaluate: **10000**  
Press **[Next]**  

Review accuracy settings summary.  
<img src="images/46-wos-accuracy-summary.png" alt="46-wos-accuracy-summary.png" width="400"/>  
Press **[Save]** and **[OK]**  
...
<img src="images/47-wos-implementation-for-feedback-data.png" alt="47-wos-implementation-for-feedback-data.png" width="400"/>  
...
<img src="images/52-wos-quality-accuracy.png" alt="52-wos-quality-accuracy.png" width="400"/>  
...
Select **Fairness** / **Sex**:  
<img src="images/54-wos-fairness-sex.png" alt="54-wos-fairness-sex.png" width="400"/>  
...
Select **Fairness** / **Age**:  
<img src="images/57-wos-fairness-age.png" alt="57-wos-fairness-age.png" width="400"/>  
...
<img src="images/59a-wos-view-transactions.png" alt="59a-wos-view-transactions.png" width="400"/>  
...
<img src="images/59b-wos-explain-transactions.png" alt="59b-wos-explain-transactions.png" width="400"/>  
...
<img src="images/61-ws-preview-notebook.png" alt="61-ws-preview-notebook.png" width="400"/>  
...
Select **Notebook**  
<img src="images/62a-ws-add-notebook.png" alt="62a-ws-add-notebook.png" width="400"/>  

Press "**From URL**" on the top and then set the Notebook values as:  
<img src="images/62b-ws-new-notebook.png" alt="62b-ws-new-notebook.png" width="400"/>  
...
<img src="images/63-ws-scoring-notebook-open.png" alt="63-ws-scoring-notebook-open.png" width="400"/>  
...
<img src="images/64-wml-credentials.png" alt="64-wml-credentials.png" width="400"/>  

Scoring End-point URL (scoring_url) is the unique address of your deployed scoring endpoint for Credit Risk model.  
<img src="images/65-wml-scoring-endpoint-url.png" alt="65-wml-scoring-endpoint-url.png" width="400"/>  
